...
class TD3ActorNetwork(nn.Module):
    def __init__(self, learning_rate, input_dims, fc1_dims, fc2_dims, n_actions, name,
        ...
        self.fc1 = nn.Linear(self.input_dims, fc1_dims, bias=False)
        self.fc2 = nn.Linear(self.fc1_dims, self.fc2_dims, bias=False)
        self.mu = nn.Linear(self.fc2_dims, self.n_actions, bias=False)
